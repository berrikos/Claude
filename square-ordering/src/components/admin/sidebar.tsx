...
const navItems = [
  ...
  { href: "/admin/storefront", label: "Storefront", icon: "globe" },
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6">
        ...
        <span className="text-lg font-semibold text-gray-900">OrderApp</span>
      </div>
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 truncate">
            ...
            <button
              onClick={() => signOut({ callbackUrl: "/login?admin=true" })}
